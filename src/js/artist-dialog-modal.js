...
// 1. Оголошуємо змінну ОДИН РАЗ на початку файлу.
// Браузер запам'ятає посилання на цей елемент і не буде шукати його знову.
...
document.addEventListener('click', (e) => {
  ...
  // --- ЛОГІКА ЗАКРИТТЯ ---
  // Сюди код дійде, тільки якщо ми НЕ натиснули кнопку відкриття.
  // Перевіряємо: Клік по хрестику АБО Клік по фону (backdrop)
